...
brickImage = r"C:\\Users\ASUS\Desktop\\Технологии программирования\DDZ(tanks)\\tank\\image\brick.png"
ironImage = r"C:\\Users\ASUS\Desktop\\Технологии программирования\DDZ(tanks)\\tank\\image\\iron.png"
...
class Map():
    def __init__(self):
        ...
        # Число представляет местоположение на карте
        # Рисуем кирпичи

...
bg_img = pygame.image.load(
    'C:/Users/ASUS/Desktop/python/tanki/resources/images/grassbg2.png')
bg_img = pygame.transform.scale(bg_img, (1000, 700))
rocket_img = pygame.image.load(
    f'C:/Users/ASUS/Desktop/python/tanki/resources/images/rocket/1.png')
detial_img = pygame.image.load(
    'C:/Users/ASUS/Desktop/python/tanki/resources/images/detials.png')
bc_img = pygame.image.load(
    'C:/Users/ASUS/Desktop/python/tanki/resources/images/intro/bc.png')
ps_img = pygame.image.load(
    'C:/Users/ASUS/Desktop/python/tanki/resources/images/intro/ps.png')
co_img = pygame.image.load(
    'C:/Users/ASUS/Desktop/python/tanki/resources/images/intro/co.png')
control_img = pygame.image.load(
    'C:/Users/ASUS/Desktop/python/tanki/resources/images/intro/control.png')
pause_img = pygame.image.load(
    'C:/Users/ASUS/Desktop/python/tanki/resources/images/intro/pause.png')
re_img = pygame.image.load(
    'C:/Users/ASUS/Desktop/python/tanki/resources/images/intro/resume.png')
qg_img = pygame.image.load(
    'C:/Users/ASUS/Desktop/python/tanki/resources/images/intro/qg.png')
rest_img = pygame.image.load(
    'C:/Users/ASUS/Desktop/python/tanki/resources/images/intro/rest.png')
score_img = pygame.image.load(
    'C:/Users/ASUS/Desktop/python/tanki/resources/images/intro/score.png')
pl_img = []
for i in range(1, 3):
    img = pygame.image.load(
        f'C:/Users/ASUS/Desktop/python/tanki/resources/images/player1/lv1/right/{i}.png')
    pl_img.append(img)

# load sounds
# tank move sound
tank_move = mixer.Sound(
    'C:/Users/ASUS/Desktop/python/tanki/resources/sound/move.ogg')
tank_move.set_volume(0.0)
tank_move.play(-1)

# bonus sound
bonus = pygame.mixer.Sound(
    'C:/Users/ASUS/Desktop/python/tanki/resources/sound/bonus.ogg')
bonus.set_volume(0.9)

# tank blast sound
tank_blast = pygame.mixer.Sound(
    'C:/Users/ASUS/Desktop/python/tanki/resources/sound/explosion.ogg')
tank_blast.set_volume(0.9)

# tank fire sound
tank_fire = pygame.mixer.Sound(
    'C:/Users/ASUS/Desktop/python/tanki/resources/sound/fire.ogg')
tank_fire.set_volume(0.9)

# brick sound
brick = pygame.mixer.Sound(
    'C:/Users/ASUS/Desktop/python/tanki/resources/sound/brick.ogg')
brick.set_volume(0.9)

# gamestart sound
gamestart = pygame.mixer.Sound(
    'C:/Users/ASUS/Desktop/python/tanki/resources/sound/gamestart.ogg')
gamestart.set_volume(0.9)

# gameover sound
gameover = pygame.mixer.Sound(
    'C:/Users/ASUS/Desktop/python/tanki/resources/sound/gameover.ogg')
gameover.set_volume(0.9)

# score sound
score = pygame.mixer.Sound(
    'C:/Users/ASUS/Desktop/python/tanki/resources/sound/score.ogg')
score.set_volume(0.9)

# steel sound
steel = pygame.mixer.Sound(
    'C:/Users/ASUS/Desktop/python/tanki/resources/sound/steel.ogg')
steel.set_volume(0.9)

# rocket_blast sound
rblast = pygame.mixer.Sound(
    'C:/Users/ASUS/Desktop/python/tanki/resources/sound/rblast.wav')
rblast.set_volume(0.9)

# high score sound
hg = pygame.mixer.Sound(
    'C:/Users/ASUS/Desktop/python/tanki/resources/sound/hg.mp3')
hg.set_volume(0.9)
...
class Tank(pygame.sprite.Sprite):
    def __init__(self, char_type, x, y, direction, level, health, speed):  # конструктор  с параметром
        ...
        self.tank_blast = []
        for i in range(1, len(os.listdir(f'C:/Users/ASUS/Desktop/python/tanki/resources/images/tank_blast'))+1):
            img = pygame.image.load(
                f"C:/Users/ASUS/Desktop/python/tanki/resources/images/tank_blast/{i}.png")
            self.tank_blast.append(img)
        self.image_blast = self.tank_blast[0]

        # load tank shiled images
        self.tank_shiled = []
        for i in range(1, len(os.listdir(f'C:/Users/ASUS/Desktop/python/tanki/resources/images/shiled'))+1):
            img = pygame.image.load(
                f"C:/Users/ASUS/Desktop/python/tanki/resources/images/shiled/{i}.png")
            self.tank_shiled.append(img)
        self.image_shiled = self.tank_shiled[0]

        # load tank spawn images
        self.tank_spawn = []
        for i in range(1, len(os.listdir(f'C:/Users/ASUS/Desktop/python/tanki/resources/images/tank_spawn'))+1):
            img = pygame.image.load(
                f"C:/Users/ASUS/Desktop/python/tanki/resources/images/tank_spawn/{i}.png")
            ...
            for animation in animation_types:
                ...
                if char_type != "player1" and char_type != "player2":
                    num_of_frames = len(os.listdir(
                        f'C:/Users/ASUS/Desktop/python/tanki/resources/images/enemy/{"lv"+str(animation_index)}/{animation}'))
                else:
                    num_of_frames = len(os.listdir(
                        f'C:/Users/ASUS/Desktop/python/tanki/resources/images/{self.char_type}/{"lv"+str(animation_index)}/{animation}'))
                for i in range(1, num_of_frames+1):
                    if char_type != "player1" and char_type != "player2":
                        img = pygame.image.load(
                            f"C:/Users/ASUS/Desktop/python/tanki/resources/images/enemy/{'lv'+str(animation_index)}/{animation}/{i}.png")
                    else:
                        img = pygame.image.load(
                            f"C:/Users/ASUS/Desktop/python/tanki/resources/images/{self.char_type}/{'lv'+str(animation_index)}/{animation}/{i}.png")
...
class Wall_blast(pygame.sprite.Sprite):
    def __init__(self, x, y, direction, tile_remove):
        ...
        self.rocket_boom = []
        for i in range(len(os.listdir("C:/Users/ASUS/Desktop/python/tanki/resources/images/rocket_boom"))):
            img = pygame.image.load(
                f"C:/Users/ASUS/Desktop/python/tanki/resources/images/rocket_boom/{i}.png")
...
class Power_up(pygame.sprite.Sprite):
    def __init__(self, data):
        ...
        for i in os.listdir("C:/Users/ASUS/Desktop/python/tanki/resources/images/powerup"):
            img = pygame.image.load(
                f"C:/Users/ASUS/Desktop/python/tanki/resources/images/powerup/{i}")

...
bg_img = pygame.image.load(
    'C:/Users/91166/Desktop/python/tanki/resources/images/grassbg2.png')
bg_img = pygame.transform.scale(bg_img, (1000, 700))
rocket_img = pygame.image.load(
    f'C:/Users/91166/Desktop/python/tanki/resources/images/rocket/1.png')
detial_img = pygame.image.load(
    'C:/Users/91166/Desktop/python/tanki/resources/images/detials.png')
bc_img = pygame.image.load(
    'C:/Users/91166/Desktop/python/tanki/resources/images/intro/bc.png')
ps_img = pygame.image.load(
    'C:/Users/91166/Desktop/python/tanki/resources/images/intro/ps.png')
co_img = pygame.image.load(
    'C:/Users/91166/Desktop/python/tanki/resources/images/intro/co.png')
control_img = pygame.image.load(
    'C:/Users/91166/Desktop/python/tanki/resources/images/intro/control.png')
pause_img = pygame.image.load(
    'C:/Users/91166/Desktop/python/tanki/resources/images/intro/pause.png')
re_img = pygame.image.load(
    'C:/Users/91166/Desktop/python/tanki/resources/images/intro/resume.png')
qg_img = pygame.image.load(
    'C:/Users/91166/Desktop/python/tanki/resources/images/intro/qg.png')
rest_img = pygame.image.load(
    'C:/Users/91166/Desktop/python/tanki/resources/images/intro/rest.png')
score_img = pygame.image.load(
    'C:/Users/91166/Desktop/python/tanki/resources/images/intro/score.png')
pl_img = []
for i in range(1, 3):
    img = pygame.image.load(
        f'C:/Users/91166/Desktop/python/tanki/resources/images/player1/lv1/right/{i}.png')
    pl_img.append(img)

# load sounds
# tank move sound
tank_move = mixer.Sound(
    'C:/Users/91166/Desktop/python/tanki/resources/sound/move.ogg')
tank_move.set_volume(0.0)
tank_move.play(-1)

# bonus sound
bonus = pygame.mixer.Sound(
    'C:/Users/91166/Desktop/python/tanki/resources/sound/bonus.ogg')
bonus.set_volume(0.9)

# tank blast sound
tank_blast = pygame.mixer.Sound(
    'C:/Users/91166/Desktop/python/tanki/resources/sound/explosion.ogg')
tank_blast.set_volume(0.9)

# tank fire sound
tank_fire = pygame.mixer.Sound(
    'C:/Users/91166/Desktop/python/tanki/resources/sound/fire.ogg')
tank_fire.set_volume(0.9)

# brick sound
brick = pygame.mixer.Sound(
    'C:/Users/91166/Desktop/python/tanki/resources/sound/brick.ogg')
brick.set_volume(0.9)

# gamestart sound
gamestart = pygame.mixer.Sound(
    'C:/Users/91166/Desktop/python/tanki/resources/sound/gamestart.ogg')
gamestart.set_volume(0.9)

# gameover sound
gameover = pygame.mixer.Sound(
    'C:/Users/91166/Desktop/python/tanki/resources/sound/gameover.ogg')
gameover.set_volume(0.9)

# score sound
score = pygame.mixer.Sound(
    'C:/Users/91166/Desktop/python/tanki/resources/sound/score.ogg')
score.set_volume(0.9)

# steel sound
steel = pygame.mixer.Sound(
    'C:/Users/91166/Desktop/python/tanki/resources/sound/steel.ogg')
steel.set_volume(0.9)

# rocket_blast sound
rblast = pygame.mixer.Sound(
    'C:/Users/91166/Desktop/python/tanki/resources/sound/rblast.wav')
rblast.set_volume(0.9)

# high score sound
hg = pygame.mixer.Sound(
    'C:/Users/91166/Desktop/python/tanki/resources/sound/hg.mp3')
hg.set_volume(0.9)
...
class Tank(pygame.sprite.Sprite):
    def __init__(self, char_type, x, y, direction, level, health, speed):  # конструктор  с параметром
        ...
        self.image = self.animation_list[self.level -
                                         1][self.action][self.frame_index]
            ...
            for tile in world.tile_list:
                if self.vision.colliderect(tile[1]):
                    ...
                    if (tile[2] == 's' and self.fire_power >= 2):
                        self.enemy_shoot()
                    if tile[2] == 'e' and (self.char_type != "player1" or self.char_type != "player2" ):
                        if tile[3] != 1:
                            self.enemy_shoot()

            if self.char_type == "player1" or self.char_type == "player2" :
...
class Wall_blast(pygame.sprite.Sprite):
    def __init__(self, x, y, direction, tile_remove):
        ...
        self.rocket_boom = []
        for i in range(len(os.listdir("C:/Users/91166/Desktop/python/tanki/resources/images/rocket_boom"))):
            img = pygame.image.load(
                f"C:/Users/91166/Desktop/python/tanki/resources/images/rocket_boom/{i}.png")
...
class Power_up(pygame.sprite.Sprite):
    def __init__(self, data):
        ...
        for i in os.listdir("C:/Users/91166/Desktop/python/tanki/resources/images/powerup"):
            img = pygame.image.load(
                f"C:/Users/91166/Desktop/python/tanki/resources/images/powerup/{i}")
            ...
            if i.born_ == False and i.alive:
                if i.rect.colliderect(self.rect.x, self.rect.y, self.image.get_width(), self.image.get_height()):
                    ...
                    if self.powerUP_lst[self.powerUP_index] == 'boom':
                        ...
                        if char_list[index] == "player1" or char_list[index] == "player2" :
...
class World():
    def __init__(self, data):
        ...
        self.img_ = pygame.image.load(
            f"C:/Users/91166/Desktop/python/tanki/resources/images/powerup/zzz.png")
        self.boarder = pygame.image.load(
            'C:/Users/91166/Desktop/python/tanki/resources/images/boarder.png')
        self.grass = pygame.image.load(
            "C:/Users/91166/Desktop/python/tanki/resources/images/grass/1.png")
        self.speed_tiled = pygame.image.load(
            "C:/Users/91166/Desktop/python/tanki/resources/images/speed_tiled/1.png")

        self.stell_wall = []
        self.stell_wall_index = 0
        for i in range(1, len(os.listdir("C:/Users/91166/Desktop/python/tanki/resources/images/stell_wall"))+1):
            img = pygame.image.load(
                f"C:/Users/91166/Desktop/python/tanki/resources/images/stell_wall/{i}.png")
            self.stell_wall.append(img)

        self.brick_wall = []
        self.brick_wall_index = 0
        for i in range(1, len(os.listdir("C:/Users/91166/Desktop/python/tanki/resources/images/brick_wall"))+1):
            img = pygame.image.load(
                f"C:/Users/91166/Desktop/python/tanki/resources/images/brick_wall/{i}.png")
            self.brick_wall.append(img)

        self.water = []
        self.water_index = 0
        for i in range(1, len(os.listdir("C:/Users/91166/Desktop/python/tanki/resources/images/water"))+1):
            img = pygame.image.load(
                f"C:/Users/91166/Desktop/python/tanki/resources/images/water/{i}.png")
            self.water.append(img)

        self.eagle = []
        self.eagle_index = 0
        for i in range(1, len(os.listdir("C:/Users/91166/Desktop/python/tanki/resources/images/eagle"))+1):
            img = pygame.image.load(
                f"C:/Users/91166/Desktop/python/tanki/resources/images/eagle/{i}.png")
            self.eagle.append(img)

        self.eagle_boom = []
        self.eagle_boom_index = 0
        for i in range(1, len(os.listdir("C:/Users/91166/Desktop/python/tanki/resources/images/boom"))+1):
            img = pygame.image.load(
                f"C:/Users/91166/Desktop/python/tanki/resources/images/boom/{i}.png")
...
class Detials():
    def __init__(self):
        ...
        for i in range(1, len(os.listdir("C:/Users/91166/Desktop/python/tanki/resources/images/intro/hs"))+1):
            img = pygame.image.load(
                f"C:/Users/91166/Desktop/python/tanki/resources/images/intro/hs/{i}.png")
            self.high_sc.append(img)

        self.high_no = []
        self.high_no_index = 0
        for i in range(0, len(os.listdir("C:/Users/91166/Desktop/python/tanki/resources/images/intro/no"))):
            img = pygame.image.load(
                f"C:/Users/91166/Desktop/python/tanki/resources/images/intro/no/{i}.png")
            self.high_no.append(img)

        self.high_no1 = []
        self.high_no_index1 = 0
        for i in range(0, len(os.listdir("C:/Users/91166/Desktop/python/tanki/resources/images/intro/no1"))):
            img1 = pygame.image.load(
                f"C:/Users/91166/Desktop/python/tanki/resources/images/intro/no1/{i}.png")
        ...
        for i in range(1, 5):
            ...
            for j in range(1, 3):
                self.pl_img = pygame.image.load(
                    f"C:/Users/91166/Desktop/python/tanki/resources/images/player{i}/lv1/up/{j}.png")
        ...
        self.score_txt_img = pygame.image.load(
            'C:/Users/91166/Desktop/python/tanki/resources/images/intro/sc.png')
...
class Game_over():
    def __init__(self):
        self.go_img = pygame.image.load(
            'C:/Users/91166/Desktop/python/tanki/resources/images/intro/go.png')
        self.speed = 1
        self.fade_counter = 0
        self.update_time = pygame.time.get_ticks()
        self.finish = False
...
# key assign
key_list = [(pygame.K_LEFT, pygame.K_RIGHT, pygame.K_UP, pygame.K_DOWN, pygame.K_KP_0),
